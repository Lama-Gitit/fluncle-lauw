...
const PUBLIC_UNAUTH_OPS = new Set<string>([
  ...
  // the label reads are blind to seed_state (crawl scope, never storage).
  "get_album",
  "get_label",
  "list_albums",
  "list_labels",
...
const EXPECTED_TIERS: Record<string, "admin" | "operator" | "private-session"> = {
  ...
  // The catalogue funnel read (docs/admin-shell.md) — admin tier: the live
  ...
  // The daily catalogue-funnel snapshot write (docs/admin-shell.md) — agent
