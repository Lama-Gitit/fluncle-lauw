...
| Public API | `https://www.fluncle.com/api/v1/*`                                      | JSON reads and submissions; the bare `/api/*` answers only for the file-route carve-outs (see [Web](#web), [Submission Flow](#submission-flow)) |
