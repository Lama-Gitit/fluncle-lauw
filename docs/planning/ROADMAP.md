...
- **Same pattern, next:** the context-distill (`distilContextNote`) and submission triage — bounded, internal, non-voice, and with **no 3 s deadline**, so their effort sweet spot may sit higher than the filter's; each wants its own bench pass before a flip.
